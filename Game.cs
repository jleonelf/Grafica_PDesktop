...
namespace Grafica_PDesktop
{
    public class Game : GameWindow
    {
        ...
        private Escenario InicializarPc()
        {
            ...
            // Coloca el MONITOR en el mundo (antes estaba en -1.2, 1.05, -6.0)
            monitor.setCentro(new Vertice(-1.2f, 1.05f, -6.0f));
            escenario.addObjeto("Monitor", monitor);

            // ==========================================================
            // TECLADO  (vértices locales; centro global editable)
            ...
            // Coloca el TECLADO en el mundo (antes: -1.2, -1.55, -5.7)
            ...
            this.cpu = new Objeto();
            {
                ...
                float sx = 0.65f;                     // sesgo X para la cara trasera
                float sy = 0.18f;                     // sesgo Y para la cara trasera
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // Dibuja todos los objetos del escenario en (0,0,0) global
